...
begin
  ...
  try
    ...
    ChkDefender.Checked := Ini.ReadBool('Settings', 'DisableDefender', False);
    ChkUpdate.Checked := Ini.ReadBool('Settings', 'DisableUpdates', False);
...
begin
  ...
  try
    ...
    Ini.WriteBool('Settings', 'DisableDefender', ChkDefender.Checked);
    Ini.WriteBool('Settings', 'DisableUpdates', ChkUpdate.Checked);
